/**
 * Vercel serverless proxy → BACKEND_URL (see api/shim.mjs).
 * When vercel.json rewrites strip paths to /api/shim?__p=rest, rebuild /api/… here.
 */
