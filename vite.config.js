        ...
        if (
          ...
          console.warn(
            '\n[overemployed] VITE_API_URL is not set for this production build. ' +
              'Either set VITE_API_URL to an https:// API origin, or set BACKEND_URL (or API_ORIGIN) ' +
              'on Vercel and leave VITE_API_URL unset so /api is proxied to EC2 (see vercel.env.example).\n'
          );
        }
      },
    },
